class ReadmeGenerator {
    ...
    getTechnologySettings() {
        ...
        return {
            ...
            express: getCheckedValue('techExpress'),
    ...
    buildTechnologyBadges(data) {
        ...
        const techBadges = {
            ...
            express: '<a href="https://expressjs.com/"><img src="https://img.shields.io/badge/Express-000000?style=for-the-badge&logo=express&logoColor=white" alt="Express"></a>',
    ...
    buildBuiltWithSection(data) {
        ...
        const techNames = {
            ...
            express: '**Express** for web application framework',
